...
import { CalendarIcon, MapPin, Users, Edit, Trash2, Phone, Mail, FileText } from "lucide-react"
                ...
                <div className="grid grid-cols-7">
                    {calendarDays.map((day, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`min-h-[120px] p-2 border-r border-b last:border-r-0 hover:bg-gray-50 ${isTodayDay ? 'bg-blue-50' : 'bg-white'
                                    }`}
                            >
                                {day && (
                                    <>
                                        <div className={`text-sm font-medium mb-1 ${isTodayDay
                                            ...
                                            {dayEvents.slice(0, 3).map((event) => {
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className="text-xs p-1 rounded cursor-pointer hover:opacity-80 text-white relative bg-blue-500"
