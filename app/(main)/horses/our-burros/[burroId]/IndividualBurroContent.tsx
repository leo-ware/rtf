...
import ExampleImage from "../../our-horses/[horseId]/example-horse-image.png"
import { ArticleRenderer } from "@/components/ArticleRenderer"
import { useEffect } from "react"
import { trackEvent, AnalyticsEvents } from "@/lib/analytics"

type IndividualBurroContentProps = {
    burroSlug: string
}

const IndividualBurroContent = ({ burroSlug }: IndividualBurroContentProps) => {
    ...
    useEffect(() => {
        if (animal) {
            trackEvent(AnalyticsEvents.HORSE_PROFILE_VIEWED, { name: animal.name, slug: burroSlug })
        }
    }, [animal, burroSlug])
    ...
    return (
        <div className="w-full h-fit my-16 flex flex-col items-center justify-start gap-16">
            ...
            <SponsorAHorseMenu
                type="burro"
                title="Explore Other Burros to Sponsor"
...
export default IndividualBurroContent
