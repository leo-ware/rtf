                    ...
                    items={[
                        {
                            ...
                            description: (
                                <div>
                                    ...
                                    and immersive workshops that bring you face to face with the mustangs and
                                    burros who call these hills home. You'll learn to recognize herd hierarchies,
                                    observe communication and movement patterns, and see how natural grazing shapes
                                    healthy ecosystems. Led by experienced guides, these programs offer an intimate
                                    view of wild horse behavior and the humane management practices that protect them.
                                    <Link href="/visit-us/events">
                                        <Button color="cinnamon" className="mt-4">Book a Tour</Button>
                                    </Link>
                                </div>
                            ),
                            image: Img1
                        ...
                        {
                            title: "Educator & Student Learning",
                            description: `
                        ...
                        {
                            title: "Volunteer & Hands-On Learning",
                            description: `
