...
const SponsorABurroPage = () => {
    ...
    return (
        <div className="w-full h-fit mb-16 flex flex-col items-center justify-start gap-16">
            <Hero title="Sponsor a Burro" image={HeroImg} />
            <Callout>
                The majority of the burros who range free at the Return to Freedom Wild Horse Sanctuary are
            ...
            <SponsorAHorseMenu title="Explore Other Burros to Sponsor" type="burro" includeInMemoriam />

        </div>
    )
}

export default SponsorABurroPage;