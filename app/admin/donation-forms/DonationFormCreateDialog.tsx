...
type DonationFormCreateDialogProps = {
    // Trigger mode (uses DialogTrigger)
...
const DonationFormCreateDialog = ({ children, isOpen: controlledIsOpen, onClose, onCreated }: DonationFormCreateDialogProps) => {
    ...
    // If in controlled mode, don't use DialogTrigger
    if (isControlled) {
        return (
    ...
    // Trigger mode with DialogTrigger
    return (
        <Dialog open={isOpen} onOpenChange={handleOpenChange}>
